...
let currentPage = 1; // - currentPage: 현재 페이지 번호
let totalPages = 1; // - totalPages: 전체 페이지 수
let currentQuery = ""; // - currentQuery: 현재 검색어
...
async function searchBooks(page = 1) {
    ...
    try {
         ...
         * [page: 1, data: [size 10]]/[page: 1, data: [size 10, id: 11~20]]/ [][][][]
         * 전체 개수 : 100 => 100 / 10 => 총 10개의 페이지
         * 101개 => 101 / 10 = 10.1 => 총 11개의 페이지
         * 1000개 => 1000 / 10 = 100 => 100개의 페이지
         * (50, 100) => 50
         */
