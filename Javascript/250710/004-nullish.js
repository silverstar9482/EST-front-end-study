...
console.log("" || "논리합(오른쪽)");
console.log("널리시(왼쪽)" ?? "hello");
// nullish -> 0, false, NaN ""과 같은 falsy 값도 유효한 값으로 간주!

// const userId = null;
// const userName = userId ?? "알 수 없는 사용자";
...
// 주의사항!
// 논리합, nullish 같이 사용하면 에러가 발생됌!
// 논리 연산자와 혼합 사용을 허용하지 않는다. => 에러 발생!
// 명시적으로 괄호를 요구 => 우선순위를 지정
const a = null;
const b = 5;
const c = 10;
// console.log(a ?? b || c) // 에러발생!
...
const city = user2?.address?.city ?? "주소 정보 없음";
